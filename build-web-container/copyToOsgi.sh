...
cp $SRC/org.apache.catalina.ha-7.0.55.*.jar $REPO/org.apache.catalina.ha/org.apache.catalina.ha-7.0.55.jar
cp $SRC/org.apache.catalina-7.0.55.*.jar $REPO/org.apache.catalina/org.apache.catalina-7.0.55.jar
cp $SRC/org.apache.catalina.tribes-7.0.55.*.jar $REPO/org.apache.catalina.tribes/org.apache.catalina.tribes-7.0.55.jar
cp $SRC/org.apache.coyote-7.0.55.*.jar $REPO/org.apache.coyote/org.apache.coyote-7.0.55.jar
cp $SRC/org.apache.el-7.0.55.*.jar $REPO/org.apache.el/org.apache.el-7.0.55.jar
cp $SRC/org.apache.jasper-7.0.55.*.jar $REPO/org.apache.jasper/org.apache.jasper-7.0.55.jar
cp $SRC/org.apache.juli.extras-7.0.55.*.jar $REPO/org.apache.juli.extras/org.apache.juli.extras-7.0.55.jar
cp $SRC/org.apache.tomcat.api-7.0.55.*.jar $REPO/org.apache.tomcat.api/org.apache.tomcat.api-7.0.55.jar
cp $SRC/org.apache.tomcat.util-7.0.55.*.jar $REPO/org.apache.tomcat.util/org.apache.tomcat.util-7.0.55.jar
cp $SRC/org.apache.tomcat.websocket-7.0.55.*.jar $REPO/org.apache.tomcat.util/org.apache.tomcat.websocket-7.0.55.jar
